...
const SURFACES := {
	...
	"plaster":   {"color": [0.88, 0.86, 0.82], "rough": 0.93, "metal": 0.0, "bump": 0.2,  "tile": 4.0},
	"marble":    {"color": [0.90, 0.89, 0.86], "rough": 0.25, "metal": 0.0, "bump": 0.1,  "tile": 5.0},
...
static func window_facade(wall: Color, glow: Color, lit: float = 1.6, cols: int = 4, rows: int = 4) -> StandardMaterial3D:
