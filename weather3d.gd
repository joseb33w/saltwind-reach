...
#  ambient Color(0.21, 0.24, 0.36) @ 0.85; prev sun clamp ceiling 1.6)
const TIME := {
	"day": {
		...
		"ambient": Color(0.55, 0.58, 0.62), "ambient_energy": 0.95,
	},
	"sunrise": {
	...
	"night": {
		...
		"ambient": Color(0.24, 0.27, 0.4), "ambient_energy": 0.9,
	},
}
